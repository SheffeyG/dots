return function(Group, c, g, s)
    ...
    Group.new("@variable.parameter", c.base08)
    Group.new("@variable.member", c.base08)
    Group.new("@variable.member.key", c.base08)
    ...
    Group.new("@keyword.function", c.base0E:light())
